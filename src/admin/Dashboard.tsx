  ...
  return (
    <>
      ...
      <div className="adm-stats">
        ...
        <div className="adm-stat green"><div className="n">{stats.links}</div><div className="l">🔗 Ссылок на MAX</div></div>
      </div>

      <div className="card">
        <h3>➕ Добавить тему</h3>
        <div className="card-sub">Выберите класс и раздел, впишите название и вставьте ссылку на пост MAX.</div>
